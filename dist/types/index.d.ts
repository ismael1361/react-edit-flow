...
interface IInputProps extends INodeDeclarationBase {
    type: "input";
    label?: string;
    value?: Partial<{
        default: string;
...
interface IConditionProps extends INodeDeclarationBase {
    type: "condition";
    operation: "egual" | "different" | "greater" | "less" | "greaterOrEgual" | "lessOrEgual";
}

interface INodeDeclarationBase {
    type: string;
}
type INodeDeclaration = IInputProps | IConditionProps;
...
declare namespace index_d$1 {
  export { index_d$1_ActionNode as ActionNode, index_d$1_BodyNode as BodyNode, index_d$1_EndNode as EndNode, index_d$1_HeaderNode as HeaderNode, index_d$1_OperationsNode as OperationsNode, index_d$1_StartNode as StartNode };
}
...
export { AddButton, type INode, type INodeDeclaration, type INodeProps, type INodeType, type IRegisterNode, index_d as Lines, index_d$1 as Nodes, ReactFlowUI, ReactFlowUI as default };
